    ...
    init: function () {
        if (document.getElementById('d3v4')) {
            ...
            var buildGraph = function () {
                ...
                claimNodes.append("switch").append("foreignObject") //needs a width and height
                .attr("width", 200).attr("height", 50).attr("class", "claim-node__foreign-object").append("xhtml:div").attr("class", "claim-node__title").html(function (d) {
