<<<<<<< HEAD
"use strict";var some_data={nodes:[{id:1},{id:2},{id:3}],edges:[{source:1,target:2},{source:1,target:3}]},alchemy$1={init:function(){"undefined"!=typeof alchemy&&(alchemy.begin({dataSource:some_data}),console.log("Alchemy initted!"))}},d3graph={init:function(){function e(){var e="http://localhost:7474".replace(/\/db\/data.*/,"");return e+"/db/data/transaction/commit"}function t(){s.attr("x1",function(e){return e.source.x}).attr("y1",function(e){return e.source.y}).attr("x2",function(e){return e.target.x}).attr("y2",function(e){return e.target.y}),c.attr("cx",function(e){return e.x}).attr("cy",function(e){return e.y})}if(document.getElementById("d3")){console.log("d3 initted!");var a=300,i=500,r={executeQuery:function(t,a,i){$.ajax(e(),{type:"POST",data:JSON.stringify({statements:[{statement:t,parameters:a||{},resultDataContents:["row","graph"]}]}),contentType:"application/json",error:function(e){i(e)},success:function(e){if(!(e.errors.length>0)){var t=[],a=[],r=[];e.results[0].data.forEach(function(e){e.graph.nodes.forEach(function(e){var a=t.filter(function(t){return t.id==e.id}).length>0;if(!a){var i=e.properties||{};i.id=e.id,i.type=e.labels[0],t.push(i),r.indexOf(i.type)==-1&&r.push(i.type)}}),a=a.concat(e.graph.relationships.map(function(e){return{source:e.startNode,target:e.endNode,caption:e.type}}))});var n={nodes:t,edges:a};return n}i(e.errors)}})}},n=d3.layout.force().size([a,i]).on("tick",t),o=d3.select("#d3").append("svg").attr("width",a).attr("height",i),s=o.selectAll(".link"),c=o.selectAll(".node"),l=r();n.nodes(l.nodes).links(l.links).start(),s=s.data(l.links).enter().append("line").attr("linkDistance",900).attr("class","link");var d=o.selectAll("g.gnode").data(l.nodes).enter().append("g").classed("gnode",!0);c=d.append("circle").attr("class","node").attr("r",50);d.append("text").attr("dx",function(e){return e.x}).attr("dy",function(e){return e.y}).text(function(e){return"data"+e.data})}}},graph={nodes:[{id:"claimOriginal",type:"claim",fx:500,fy:100,text:"Prisoners should get rehabilitation."},{id:"argForRehab",type:"argument"},{id:"claimRehabIsCheap",type:"claim",text:"The cost of rehabilitation is less than the cost of prison."},{id:"claimCheapIsGood",type:"claim",text:"The lowest cost option is best."},{id:"binaryClaim",type:"claim",text:"There is only a choice between prison or rehab."},{id:"argAgainstBinary",type:"argument"},{id:"claimExecutionIsPossible",type:"claim",text:"It is possible to execute prisoners."},{id:"claimReleaseIsPossible",type:"claim",text:"It is possible to release prisoners."},{id:"argAgainstPossibleRelease",type:"argument"},{id:"claimCannotRelease",type:"claim",text:"Releasing prisoners is not an option for society."},{id:"argAgainstNoRelease",type:"argument"},{id:"claimUnacceptable",type:"claim",text:"Commiting crimes is unacceptable in society."},{id:"claimHighChanec",type:"claim",text:"There is a high chance a criminal will commit a crime again if nothing changes in their situation."},{id:"claimModified",type:"claim",text:"Prisoners should get rehabilitation for the good of society."},{id:"argAgainstModifiedRehab",type:"argument"},{id:"expandedBinaryClaim",type:"claim",text:"There is only a choice between prison or rehab when considering whats best for society."},{id:"argAgainstNewBinary",type:"argument"},{id:"expandedBinaryClaim",type:"claim"},{id:"claimExecutionImmoral",type:"claim",text:"Executing prisoners is immoral."},{id:"claimFlatEarth",type:"claim",text:"The Earth is flat."},{id:"claimSphericalEarth",type:"claim",text:"The Earth is spherical."},{id:"claimConicalEarth",type:"claim",text:"The Earth is a cone."},{id:"earthExclusive",type:"mutualExclusiveGroup"},{id:"claimNorthNegative",type:"claim",text:"The North Pole has a negative charge."},{id:"claimNorthPositive",type:"claim",text:"The North Pole has a positive charge."}],links:[{source:"argForRehab",target:"claimOriginal",type:"SUPPORTS"},{source:"claimRehabIsCheap",target:"argForRehab",type:"USED_IN"},{source:"claimCheapIsGood",target:"argForRehab",type:"USED_IN"},{source:"binaryClaim",target:"argForRehab",type:"USED_IN"},{source:"argAgainstBinary",target:"binaryClaim",type:"OPPOSES"},{source:"argAgainstBinary",target:"binaryClaim",type:"OPPOSES"},{source:"claimExecutionIsPossible",target:"argAgainstBinary",type:"USED_IN"},{source:"claimReleaseIsPossible",target:"argAgainstBinary",type:"USED_IN"},{source:"argAgainstPossibleRelease",target:"claimReleaseIsPossible",type:"OPPOSES"},{source:"claimCannotRelease",target:"argAgainstPossibleRelease",type:"USED_IN"},{source:"argAgainstNoRelease",target:"claimCannotRelease",type:"OPPOSES"},{source:"claimUnacceptable",target:"argAgainstNoRelease",type:"USED_IN"},{source:"claimHighChanec",target:"argAgainstNoRelease",type:"USED_IN"},{source:"argAgainstModifiedRehab",target:"claimModified",type:"OPPOSES"},{source:"claimRehabIsCheap",target:"argAgainstModifiedRehab",type:"USED_IN"},{source:"claimCheapIsGood",target:"argAgainstModifiedRehab",type:"USED_IN"},{source:"expandedBinaryClaim",target:"argAgainstModifiedRehab",type:"USED_IN"},{source:"argAgainstNewBinary",target:"expandedBinaryClaim",type:"OPPOSES"},{source:"claimCannotRelease",target:"argAgainstNewBinary",type:"USED_IN"},{source:"claimExecutionImmoral",target:"argAgainstNewBinary",type:"USED_IN"},{source:"claimFlatEarth",target:"earthExclusive",type:"MUTUAL_EXCLUSION_LINK"},{source:"claimSphericalEarth",target:"earthExclusive",type:"MUTUAL_EXCLUSION_LINK"},{source:"claimConicalEarth",target:"earthExclusive",type:"MUTUAL_EXCLUSION_LINK"},{source:"claimNorthNegative",target:"claimNorthPositive",type:"MUTUALLY_EXCLUDES"}]},d3v4graph={init:function(){function e(){c.attr("x1",function(e){return e.source.x}).attr("y1",function(e){return e.source.y}).attr("x2",function(e){return e.target.x}).attr("y2",function(e){return e.target.y}),l.attr("transform",function(e){return"translate("+e.x+","+e.y+")"})}function t(e){d3.event.active||s.alphaTarget(.3).restart(),e.fx=e.x,e.fy=e.y}function a(e){e.fx=d3.event.x,e.fy=d3.event.y}function i(e){d3.event.active||s.alphaTarget(0),e.fx=null,e.fy=null}if(document.getElementById("d3v4")){var r=document.getElementById("d3v4").offsetWidth,n=.75*r,o=d3.select("#d3v4").append("svg").attr("width",r).attr("height",n),s=d3.forceSimulation().force("link",d3.forceLink().id(function(e){return e.id})).force("charge",d3.forceManyBody().distanceMin(600)).force("center",d3.forceCenter(r/2,n/2)),c=o.append("g").attr("class","links").selectAll("line").data(graph.links).enter().append("line").attr("stroke",function(e){return"OPPOSES"==e.type?"red":"SUPPORTS"==e.type?"green":"black"}),l=o.append("g").attr("class","nodes").selectAll("circle").data(graph.nodes).enter().append("g").attr("class",function(e){return e.type+"-node"}).call(d3.drag().on("start",t).on("drag",a).on("end",i));l.append("switch").append("foreignObject").attr("width",200).attr("height",100).attr("class",function(e){return e.type+"-node__foreign-object"}).append("xhtml:div").attr("class",function(e){return e.type+"-node__title"}).html(function(e){return"claim"==e.type?e.text:e.id}),s.nodes(graph.nodes).on("tick",e),s.force("link").links(graph.links)}}};window.onload=function(){alchemy$1.init(),d3graph.init(),d3v4graph.init()};
=======
'use strict';
